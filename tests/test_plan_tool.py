...
def _fixture_profile() -> AthleteProfileRow:
    return AthleteProfileRow(
        ...
        weekly_hours_json='{"monday": 1.5, "wednesday": 1.5, "saturday": 2.5, "sunday": 2.0}',
        swim_baseline="1500m in 30min",
        bike_baseline="40km in 75min",
        run_baseline="10km in 52min",
...
def test_generate_training_plan_persists_four_phases(tmp_path) -> None:
    ...
    repo.save_profile(
        ...
        swim_baseline=profile.swim_baseline,
        bike_baseline=profile.bike_baseline,
        run_baseline=profile.run_baseline,
